(function () {
  ...
  var __vue_render__ = function() {
    ...
    return _c("span", { staticClass: "storeinput" }, [
      _c("input", {
        directives: [
          {
            name: "model",
        ...
        attrs: {
          ...
          min: _vm.range && _vm.range.min,
          max: _vm.range && _vm.range.max,
          step: _vm.range && _vm.range.step,
  ...
  __vue_render__._withStripped = true;
    ...
    const __vue_inject_styles__ = function (inject) {
      if (!inject) return
      inject("data-v-a1eb4978_0", { source: "\n.storeinput[data-v-a1eb4978]\n{\n\tposition: relative;\n}\n", map: {"version":3,"sources":["F:\\Documents\\Works\\Lab\\diffusers-web\\app\\storeinput.vue"],"names":[],"mappings":";AAwFA;;CAEA,kBAAA;AACA","file":"storeinput.vue","sourcesContent":["<template>\r\n\t<span class=\"storeinput\">\r\n\t\t<input\r\n\t\t\t:type=\"type\"\r\n\t\t\tv-model.lazy=\"innerValue\"\r\n\t\t\t:style=\"styleObj\"\r\n\t\t\t:placeholder=\"placeholder\"\r\n\t\t\t:min=\"range && range.min\"\r\n\t\t\t:max=\"range && range.max\"\r\n\t\t\t:step=\"range && range.step\"\r\n\t\t\t:disabled=\"disabled\"\r\n\t\t/>\r\n\t</span>\r\n</template>\r\n\r\n<script>\r\n\texport default {\r\n\t\tname: \"store-input\",\r\n\r\n\r\n\t\tprops: {\r\n\t\t\ttype: {\r\n\t\t\t\ttype: String,\r\n\t\t\t\tdefault: \"text\",\r\n\t\t\t},\r\n\r\n\t\t\tvalue: {\r\n\t\t\t\tvalidator () {return true;},\r\n\t\t\t},\r\n\r\n\t\t\trange: Object,\r\n\r\n\t\t\tstyleObj: Object,\r\n\r\n\t\t\tplaceholder: String,\r\n\r\n\t\t\tlocalKey: String,\r\n\t\t\tsessionKey: String,\r\n\r\n\t\t\tdisabled: Boolean,\r\n\t\t},\r\n\r\n\r\n\t\tcomputed: {\r\n\t\t\tinnerValue: {\r\n\t\t\t\tget () {\r\n\t\t\t\t\treturn this.value;\r\n\t\t\t\t},\r\n\r\n\t\t\t\tset (value) {\r\n\t\t\t\t\tthis.$emit(\"input\", value);\r\n\t\t\t\t},\r\n\t\t\t},\r\n\t\t},\r\n\r\n\r\n\t\tcreated () {\r\n\t\t\tthis.load();\r\n\t\t},\r\n\r\n\r\n\t\tmethods: {\r\n\t\t\tload () {\r\n\t\t\t\tif (this.localKey && localStorage[`storeInput-${this.localKey}`])\r\n\t\t\t\t\tthis.innerValue = JSON.parse(localStorage[`storeInput-${this.localKey}`]);\r\n\r\n\t\t\t\tif (this.sessionKey && sessionStorage[`storeInput-${this.sessionKey}`])\r\n\t\t\t\t\tthis.innerValue = JSON.parse(sessionStorage[`storeInput-${this.sessionKey}`]);\r\n\t\t\t},\r\n\r\n\r\n\t\t\tsave () {\r\n\t\t\t\tif (this.localKey)\r\n\t\t\t\t\tlocalStorage[`storeInput-${this.localKey}`] = JSON.stringify(this.value);\r\n\r\n\t\t\t\tif (this.sessionKey)\r\n\t\t\t\t\tsessionStorage[`storeInput-${this.sessionKey}`] = JSON.stringify(this.value);\r\n\t\t\t},\r\n\t\t},\r\n\r\n\r\n\t\twatch: {\r\n\t\t\tvalue: \"save\",\r\n\t\t},\r\n\t};\r\n</script>\r\n\r\n<style scoped>\r\n\t.storeinput\r\n\t{\r\n\t\tposition: relative;\r\n\t}\r\n</style>\r\n"]}, media: undefined });

    };
    /* scoped */
    const __vue_scope_id__ = "data-v-a1eb4978";
    /* module identifier */
  ...
  var __vue_render__$1 = function() {
    ...
    return _c(
      "div",
      {
        ...
        class: { resizing: _vm.resizing },
        style: {
          left: _vm.left + "px",
          width: _vm.right - _vm.left + "px",
          top: _vm.top + "px",
          height: _vm.bottom - _vm.top + "px"
        }
      },
      [
        _vm.resizing
          ? _c("span", { staticClass: "label" }, [
              _vm._v(
                _vm._s(_vm.right - _vm.left) +
                  " × " +
                  _vm._s(_vm.bottom - _vm.top)
              )
            ])
          : _vm._e(),
        _vm._v(" "),
        _c(
          ...
          {
            staticClass: "inner",
            on: { mousemove: _vm.onMove, mouseup: _vm.onUp }
          },
          [
            _c("div", {
              staticClass: "lt",
            ...
            _c("div", {
              ...
              on: {
                mousedown: function($event) {
                  return _vm.onDown($event, null, "t")
                }
              }
            }),
            _vm._v(" "),
            ...
            _c("div", {
              ...
              on: {
                mousedown: function($event) {
                  return _vm.onDown($event, "l", null)
                }
              }
            }),
            _vm._v(" "),
            _c("div", {
              ...
              on: {
                mousedown: function($event) {
                  return _vm.onDown($event, null, null)
                }
              }
            }),
            _vm._v(" "),
            _c("div", {
              ...
              on: {
                mousedown: function($event) {
                  return _vm.onDown($event, "r", null)
                }
              }
            }),
            _vm._v(" "),
            ...
            _c("div", {
              ...
              on: {
                mousedown: function($event) {
                  return _vm.onDown($event, null, "b")
                }
              }
            }),
            _vm._v(" "),
  ...
  __vue_render__$1._withStripped = true;
    ...
    var ResizeBox = normalizeComponent_1(
  ...
  var __vue_staticRenderFns__$2 = [
    function() {
      ...
      var _h = _vm.$createElement;
      var _c = _vm._self._c || _h;
      return _c("div", { staticClass: "loading-dots" }, [
  ...
  __vue_render__$2._withStripped = true;
    ...
    const __vue_inject_styles__$2 = function (inject) {
      if (!inject) return
      inject("data-v-1ea93610_0", { source: "\n.loading-dots[data-v-1ea93610]\n{\n\tposition: absolute;\n\ttop: 0;\n\tleft: 0;\n\twidth: 100%;\n\theight: 100%;\n\tbackground-color: #fff4;\n}\n.ellipsis[data-v-1ea93610] {\n\tdisplay: inline-block;\n\tposition: absolute;\n\ttop: 50%;\n\tleft: 50%;\n\ttransform: translate(-50%, -50%);\n\twidth: 80px;\n\theight: 80px;\n}\n.ellipsis div[data-v-1ea93610] {\n\tposition: absolute;\n\ttop: 33px;\n\twidth: 13px;\n\theight: 13px;\n\tborder-radius: 50%;\n\tbackground: #666c;\n\tanimation-timing-function: cubic-bezier(0, 1, 1, 0);\n}\n.ellipsis div[data-v-1ea93610]:nth-child(1) {\n\tleft: 8px;\n\tanimation: ellipsis1-data-v-1ea93610 0.6s infinite;\n}\n.ellipsis div[data-v-1ea93610]:nth-child(2) {\n\tleft: 8px;\n\tanimation: ellipsis2-data-v-1ea93610 0.6s infinite;\n}\n.ellipsis div[data-v-1ea93610]:nth-child(3) {\n\tleft: 32px;\n\tanimation: ellipsis2-data-v-1ea93610 0.6s infinite;\n}\n.ellipsis div[data-v-1ea93610]:nth-child(4) {\n\tleft: 56px;\n\tanimation: ellipsis3-data-v-1ea93610 0.6s infinite;\n}\n@keyframes ellipsis1-data-v-1ea93610 {\n0% {\n\t\ttransform: scale(0);\n}\n100% {\n\t\ttransform: scale(1);\n}\n}\n@keyframes ellipsis3-data-v-1ea93610 {\n0% {\n\t\ttransform: scale(1);\n}\n100% {\n\t\ttransform: scale(0);\n}\n}\n@keyframes ellipsis2-data-v-1ea93610 {\n0% {\n\t\ttransform: translate(0, 0);\n}\n100% {\n\t\ttransform: translate(24px, 0);\n}\n}\n", map: {"version":3,"sources":["F:\\Documents\\Works\\Lab\\diffusers-web\\app\\loading-dots.vue"],"names":[],"mappings":";AAkBA;;CAEA,kBAAA;CACA,MAAA;CACA,OAAA;CACA,WAAA;CACA,YAAA;CACA,uBAAA;AACA;AAEA;CACA,qBAAA;CACA,kBAAA;CACA,QAAA;CACA,SAAA;CACA,gCAAA;CACA,WAAA;CACA,YAAA;AACA;AAEA;CACA,kBAAA;CACA,SAAA;CACA,WAAA;CACA,YAAA;CACA,kBAAA;CACA,iBAAA;CACA,mDAAA;AACA;AAEA;CACA,SAAA;CACA,kDAAA;AACA;AAEA;CACA,SAAA;CACA,kDAAA;AACA;AAEA;CACA,UAAA;CACA,kDAAA;AACA;AAEA;CACA,UAAA;CACA,kDAAA;AACA;AAEA;AACA;EACA,mBAAA;AACA;AACA;EACA,mBAAA;AACA;AACA;AAEA;AACA;EACA,mBAAA;AACA;AACA;EACA,mBAAA;AACA;AACA;AAEA;AACA;EACA,0BAAA;AACA;AACA;EACA,6BAAA;AACA;AACA","file":"loading-dots.vue","sourcesContent":["<template>\r\n\t<div class=\"loading-dots\">\r\n\t\t<div class=\"ellipsis\">\r\n\t\t\t<div></div>\r\n\t\t\t<div></div>\r\n\t\t\t<div></div>\r\n\t\t\t<div></div>\r\n\t\t</div>\r\n\t</div>\r\n</template>\r\n\r\n<script>\r\n\texport default {\r\n\t\tname: \"loading-dots\",\r\n\t};\r\n</script>\r\n\r\n<style scoped>\r\n\t.loading-dots\r\n\t{\r\n\t\tposition: absolute;\r\n\t\ttop: 0;\r\n\t\tleft: 0;\r\n\t\twidth: 100%;\r\n\t\theight: 100%;\r\n\t\tbackground-color: #fff4;\r\n\t}\r\n\r\n\t.ellipsis {\r\n\t\tdisplay: inline-block;\r\n\t\tposition: absolute;\r\n\t\ttop: 50%;\r\n\t\tleft: 50%;\r\n\t\ttransform: translate(-50%, -50%);\r\n\t\twidth: 80px;\r\n\t\theight: 80px;\r\n\t}\r\n\r\n\t.ellipsis div {\r\n\t\tposition: absolute;\r\n\t\ttop: 33px;\r\n\t\twidth: 13px;\r\n\t\theight: 13px;\r\n\t\tborder-radius: 50%;\r\n\t\tbackground: #666c;\r\n\t\tanimation-timing-function: cubic-bezier(0, 1, 1, 0);\r\n\t}\r\n\r\n\t.ellipsis div:nth-child(1) {\r\n\t\tleft: 8px;\r\n\t\tanimation: ellipsis1 0.6s infinite;\r\n\t}\r\n\r\n\t.ellipsis div:nth-child(2) {\r\n\t\tleft: 8px;\r\n\t\tanimation: ellipsis2 0.6s infinite;\r\n\t}\r\n\r\n\t.ellipsis div:nth-child(3) {\r\n\t\tleft: 32px;\r\n\t\tanimation: ellipsis2 0.6s infinite;\r\n\t}\r\n\r\n\t.ellipsis div:nth-child(4) {\r\n\t\tleft: 56px;\r\n\t\tanimation: ellipsis3 0.6s infinite;\r\n\t}\r\n\r\n\t@keyframes ellipsis1 {\r\n\t\t0% {\r\n\t\t\ttransform: scale(0);\r\n\t\t}\r\n\t\t100% {\r\n\t\t\ttransform: scale(1);\r\n\t\t}\r\n\t}\r\n\r\n\t@keyframes ellipsis3 {\r\n\t\t0% {\r\n\t\t\ttransform: scale(1);\r\n\t\t}\r\n\t\t100% {\r\n\t\t\ttransform: scale(0);\r\n\t\t}\r\n\t}\r\n\r\n\t@keyframes ellipsis2 {\r\n\t\t0% {\r\n\t\t\ttransform: translate(0, 0);\r\n\t\t}\r\n\t\t100% {\r\n\t\t\ttransform: translate(24px, 0);\r\n\t\t}\r\n\t}\r\n</style>\r\n"]}, media: undefined });

    };
    /* scoped */
    const __vue_scope_id__$2 = "data-v-1ea93610";
    /* module identifier */
  ...
  var __vue_render__$3 = function() {
    ...
    return _c(
      "div",
      { staticClass: "painter", on: { copy: _vm.onCopy, paste: _vm.onPaste } },
      [
        _c("main", { ref: "main" }, [
          _c("canvas", {
            ref: "canvas",
            staticClass: "canvas",
            attrs: { width: _vm.canvasSize.width, height: _vm.canvasSize.height }
          }),
          _vm._v(" "),
          _c(
            "div",
            {
              ...
              on: { mousemove: _vm.onBenchMouseMove }
            },
            [
              _c("ResizeBox", {
                staticClass: "diffuser-box",
                attrs: {
                  left: _vm.diffuserBox.left,
                  right: _vm.diffuserBox.right,
                  top: _vm.diffuserBox.top,
                  bottom: _vm.diffuserBox.bottom
                },
                on: {
                  "update:left": function($event) {
                    return _vm.$set(_vm.diffuserBox, "left", $event)
                  },
                  "update:right": function($event) {
                    return _vm.$set(_vm.diffuserBox, "right", $event)
                  },
                  "update:top": function($event) {
                    return _vm.$set(_vm.diffuserBox, "top", $event)
                  },
                  "update:bottom": function($event) {
                    return _vm.$set(_vm.diffuserBox, "bottom", $event)
                  },
                  released: _vm.onBoxResized
                }
              })
            ],
            1
        ...
        _vm._v(" "),
        _vm.painting ? _c("Loading") : _vm._e(),
        _vm._v(" "),
        _c(
          "header",
          [
            _c("StoreInput", {
              ...
              attrs: { sessionKey: "description", type: "text" },
              model: {
            ...
            _c("StoreInput", {
              ...
              attrs: { sessionKey: "n_steps", type: "number" },
              model: {
                value: _vm.n_steps,
                callback: function($$v) {
                  _vm.n_steps = $$v;
            ...
            _vm._v(" "),
            _c("section", [
              _c("button", { on: { click: _vm.clear } }, [_vm._v("⎚")]),
              _vm._v(" "),
              _c("button", { on: { click: _vm.copy } }, [_vm._v("⎘")]),
              _vm._v(" "),
              _c("button", { on: { click: _vm.download } }, [_vm._v("⤓")])
            ]),
            _vm._v(" "),
            _c("section", [
              _c("input", {
                ...
                attrs: { type: "text", placeholder: "prompt text" },
              ...
              _c("input", {
                ...
                attrs: { type: "number", min: "1", max: "250", title: "steps" },
                domProps: { value: _vm.n_steps },
                on: {
                  input: function($event) {
                    if ($event.target.composing) {
                      return
                    }
                    _vm.n_steps = _vm._n($event.target.value);
                  },
                  blur: function($event) {
              ...
              _c(
                "button",
                { attrs: { disabled: _vm.painting }, on: { click: _vm.inpaint } },
                [_vm._v("🖌")]
              )
            ])
          ],
