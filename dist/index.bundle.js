      ...
      _c(
        ...
        [
          ...
          _c(
            "button",
            {
              attrs: { title: "Give me an idea." },
              on: { click: _vm.rollDescription }
            },
            [_vm._v("🎲")]
          ),
          _vm._v(" "),
          ...
          _c("StoreInput", {
            ...
            attrs: { sessionKey: "multi", type: "number" },
            model: {
              value: _vm.multi,
              callback: function($$v) {
                _vm.multi = $$v;
          ...
          _c("StoreInput", {
            ...
            attrs: { sessionKey: "size_w", type: "number" },
            model: {
              value: _vm.width,
              callback: function($$v) {
                _vm.width = $$v;
          ...
          _c("StoreInput", {
            ...
            attrs: { sessionKey: "size_h", type: "number" },
            model: {
              value: _vm.height,
              callback: function($$v) {
                _vm.height = $$v;
            ...
            "select",
            {
              ...
              on: {
                change: function($event) {
                  ...
                  _vm.multi = $event.target.multiple
                    ? $$selectedVal
                    : $$selectedVal[0];
                }
              }
          ...
          _c("span", [
            _c(
              ...
              _vm._l(14, function(i) {
                return _c(
                  "option",
                  { key: i, domProps: { value: 64 * (i + 2) } },
                  [_vm._v(_vm._s(64 * (i + 2)))]
                )
              }),
              0
            ),
          ...
          _c(
            "button",
            { staticClass: "submit", on: { click: _vm.paintByText } },
            [_vm._v("💭")]
          )
        ],
        1
        ...
        _vm._l(_vm.results, function(result, i) {
          return _c("section", { key: i }, [
            ...
            result.images
              ? _c(
                  "div",
                  _vm._l(result.images, function(img, ii) {
                    return _c("div", { key: ii, staticClass: "picture" }, [
                      _c("img", {
                        attrs: { src: img },
