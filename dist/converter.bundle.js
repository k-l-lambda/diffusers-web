    ...
    return _c(
      "div",
      {
        ...
        on: {
          ...
          drageleave: function($event) {
            _vm.drageHover = false;
          },
      ...
      [
        _c(
          ...
          [
            _c("img", {
              staticClass: "source",
              class: { "drop-hover": _vm.drageHover },
              attrs: { src: _vm.sourceURL }
            }),
            _vm._v(" "),
            _c("input", {
              directives: [
            ...
            _c("StoreInput", {
              ...
              attrs: { sessionKey: "strength", type: "number" },
              model: {
                value: _vm.strength,
                callback: function($$v) {
                  _vm.strength = $$v;
            ...
            _c("input", {
              ...
              attrs: { type: "number", min: "1", max: "250", size: 1 },
            ...
            _c("input", {
              ...
              attrs: { type: "range", min: "0", max: "1", step: "any" },
              domProps: { value: _vm.strength },
              on: {
                __r: function($event) {
                  _vm.strength = _vm._n($event.target.value);
                },
                blur: function($event) {
                  return _vm.$forceUpdate()
                }
            ...
            _vm._v(" "),
            _c("em", { attrs: { title: "strength" } }, [
              _vm._v(_vm._s(_vm.strength.toFixed(2)))
            ]),
            _vm._v(" "),
            _c("button", { staticClass: "submit", on: { click: _vm.paint } }, [
              _vm._v("💭")
            ])
          ],
          1
        ...
        _c(
          ...
          _vm._l(_vm.results, function(result, i) {
            return _c("section", { key: i }, [
              _c("div", [
                _c("em", { domProps: { textContent: _vm._s(result.prompt) } }),
                result.loading ? _c("span", [_vm._v("...")]) : _vm._e()
              ]),
              _vm._v(" "),
              result.source
                ? _c("div", { staticClass: "images" }, [
                    result.source
                      ? _c("img", { attrs: { src: result.source } })
                      : _vm._e(),
                    _vm._v(" "),
                    _c("span", [_vm._v("⇨")]),
                    _vm._v(" "),
                    _c("div", { staticClass: "picture" }, [
                      result.target
                        ? _c("img", { attrs: { src: result.target } })
                        : _vm._e(),
                      _vm._v(" "),
                      _c(
                        "a",
              ...
              result.error
                ? _c("p", {
                    staticClass: "error",
                    domProps: { innerHTML: _vm._s(result.error) }
                  })
                : _vm._e(),
              _vm._v(" "),
              _c("hr")
